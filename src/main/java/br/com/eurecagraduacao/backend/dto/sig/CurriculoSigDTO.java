package br.com.eurecagraduacao.backend.dto.sig;
...
public class CurriculoSigDTO {
    ...
    public static CurriculoSigDTO fromModel(FullCurriculumSigModel model) {
        CurriculoSigDTO dto = new CurriculoSigDTO();
